...
<html>
	<head>
		...
		<meta charset="utf-8">
		<link rel="stylesheet" type="text/css" href="acessorio.css">
	...
	<body>
		...
		<div class="cm1">
				<div class="pedido">
					<img src="fr/a1.jpg" width="90%" class="ff">
				...
				<div class="inf">
					...
					<form method="GET" action="enviar.php">
						<table>
						<input type="text" name="r" value="a1" >
		...
		<div class="cm2">
				<div class="pedido">
					<img src="fr/a2.jpg" width="90%" class="ff">
				...
				<div class="inf">
					...
					<center>
					<h2>R$ 15,00</h2>
		            <font class="c"> OU ATÉ 2X DE $8,00</font><br>
		            <img src="img/frete.png" width="30px"> Frete grátis para todo país
					</center>
					...
					<form method="GET" action="enviar.php">
						<table>
						<input type="text" name="r" value="a2" >
		                <tr><td align="right">Cidade</td> <td align="center"><input type="text" name="cid" placeholder="Cidade" required></td></tr>
		...
		<div class="cm3">
				<div class="pedido">
					<img src="fr/a3.jpg" width="90%" class="ff">
				...
				<div class="inf">
					...
					<form method="GET" action="enviar.php">
						<table>
						<input type="text" name="r" value="a3" >
		               <tr><td align="right">Cidade</td> <td align="center"><input type="text" name="cid" placeholder="Cidade" required></td></tr>
		...
		<div class="cm4">
				<div class="pedido">
					<img src="fr/a10.jpg" width="90%" class="ff">
				...
				<div class="inf">
					...
					<form method="GET" action="enviar.php">
						<table>
						<input type="text" name="r" value="a4" >
		               <tr><td align="right">Cidade</td> <td align="center"><input type="text" name="cid" placeholder="Cidade" required></td></tr>
		...
		<div class="cm5">
				<div class="pedido">
					<img src="fr/a5.jpg" width="90%" class="ff">

				</div>
				<div class="inf">
					<font class="fec" size="6">X</font>
					<h1>Chapeu Corinthians</h1> 
					<center>
					<h2>R$ 45,00</h2>
		            <font class="c"> OU ATÉ 3X DE $15,00</font><br>
		            <img src="img/frete.png" width="30px"> Frete grátis para todo país
					</center>
					...
					<form method="GET" action="enviar.php">
						<table>
						<input type="text" name="r" value="a5" >
		               <tr><td align="right">Cidade</td> <td align="center"><input type="text" name="cid" placeholder="Cidade" required></td></tr>
		...
		<div class="cm6">
				<div class="pedido">
					<img src="fr/a9.jpg" width="90%" class="ff">
				...
				<div class="inf">
					...
					<form method="GET" action="enviar.php">
						<table>
						<input type="text" name="r" value="a9" >
		                <tr><td align="right">Cidade</td> <td align="center"><input type="text" name="cid" placeholder="Cidade" required></td></tr>
		...
		<div class="cm7">
				<div class="pedido">
					<img src="fr/a7.jpg" width="90%" class="ff">
				...
				<div class="inf">
					...
					<form method="GET" action="enviar.php">
						<table>
						<input type="text" name="r" value="a7" >
		                <tr><td align="right">Cidade</td> <td align="center"><input type="text" name="cid" placeholder="Cidade" required></td></tr>
		...
		<div class="cm8">
				<div class="pedido">
					<img src="fr/a8.jpg" width="90%" class="ff">
				...
				<div class="inf">
					...
					<form method="GET" action="enviar.php">
						<table>
						<input type="text" name="r" value="a8" >
		               <tr><td align="right">Cidade</td> <td align="center"><input type="text" name="cid" placeholder="Cidade" required></td></tr>
		...
		<div class="corpo">
			<div class="produtos">
					...
					<div class="f">
						<img src="fr/a1.jpg" width="250px"><br>
					...
					<div class="f">
						<img src="fr/a2.jpg" width="250px" class="bm2"><br>
						<h2>Por R$ 15,00</h2><br>
						OU ATÉ 2X DE $8,00<br>
						SEM JUROS<br>
						<input type="submit" value="Pedido" class="bm2">
					</div>
					<div class="f">
						<img src="fr/a3.jpg" width="250px"><br>
					...
					<div class="f">
						<img src="fr/a10.jpg" width="250px"><br>
						<h2>Por R$ 25,00</h2><br>
						OU ATÉ 3X DE $13,00<br>
						SEM JUROS<br>
					...
					<div class="f">
						<img src="fr/a5.jpg" width="250px"><br>
						<h2>Por R$ 45,00</h2><br>
						OU ATÉ 3X DE $15,00<br>
						SEM JUROS<br>
					...
					<div class="f">
						<img src="fr/a9.jpg" width="250px"><br>
						<h2>Por R$ 25,00</h2><br>
						OU ATÉ 3X DE $13,00<br>
						SEM JUROS<br>
					...
					<div class="f">
						<img src="fr/a7.jpg" width="250px"><br>
					...
					<div class="f">
						<img src="fr/a8.jpg" width="250px"><br>
						<h2>Por R$ 30,00</h2><br>
						OU ATÉ 2X DE $15,00<br>
						SEM JUROS<br>
